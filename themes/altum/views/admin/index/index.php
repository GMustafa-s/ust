    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <?php while($row = $result->fetch_object()): ?>
                <?php //Saivra:DEMO if(DEMO) {$row->email = 'hidden@demo.com'; $row->name = 'hidden on demo';} ?>
        ...
        <div class="mb-5">
            ...
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    ...
                    <tbody>
                    <?php while($row = $result->fetch_object()): ?>
                        <?php //Saivra:DEMO if(DEMO) {$row->email = $row->user_email = 'hidden@demo.com'; $row->user_name = $row->name = 'hidden on demo';} ?>
    ...
    <div class="col-12 col-sm-6 col-xl-4 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2"><span class="h6">saivra.net</span></div>
            </div>

            <div class="px-2 d-flex flex-column justify-content-center">
                <a href="https://saivra.net" class="stretched-link" target="_blank">
                    <i class="fa fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-4 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2"><span class="h6">support@saivra.net</span></div>
            </div>

            <div class="px-2 d-flex flex-column justify-content-center">
                <a href="https://saivra.net/contact" class="stretched-link" target="_blank">
                    <i class="fa fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-4 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2"><span class="h6">@saivra</span></div>
            </div>
