...
<footer class="mt-5 d-flex flex-column flex-lg-row justify-content-between">
    <div class="mb-3 mb-lg-0">
        ...
        <div>Powered by <img src="<?= ASSETS_FULL_URL . 'images/saivra.png' ?>" class="icon-favicon" alt="SaivraTechnologies logo" /> <a href="https://saivra.net/" target="_blank">SaivraTechnologies</a>.</div>
    </div>
