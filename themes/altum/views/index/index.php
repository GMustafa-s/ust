...
<div class="container">
    ...
    <div id="tools">
        <?php function get_tools_section_output($file_name, $user, $data) { ?>
            ...
            <?php foreach(require APP_PATH . 'includes/' . $file_name . '.php' as $key => $value): ?>
        ...
        <?php foreach(['checker_tools', 'text_tools', 'converter_tools', 'generator_tools', 'developer_tools', 'misc_tools', 'unit_converter_tools'] as $tool): ?>
