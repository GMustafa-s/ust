        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="image"><i class="fa fa-fw fa-sm fa-image text-muted mr-1"></i> <?= l('tools.ico_to_png.image') ?></label>
                ...
                <div class="form-group">
                    <label for="quality"><i class="fa fa-fw fa-sort-numeric-up fa-sm text-muted mr-1"></i> <?= l('tools.ico_to_png.quality') ?></label>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <label for="result"><?= l('tools.ico_to_png.result') ?></label>
                    <div>
                        <a
                                href=""
                                target="_blank"
                                ...
                                download="<?= l('tools.ico_to_png.result') . '.png' ?>"
                                id="download"
                        >
