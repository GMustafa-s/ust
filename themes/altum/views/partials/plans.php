        ...
        >
            <div class="card pricing-card h-100" style="<?= $plan->color ? 'border-color: ' . $plan->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-4 text-center">
                        <div class="h1 d-none" data-plan-payment-frequency="monthly"><?= $plan->monthly_price ?></div>
                        <div class="h1 d-none" data-plan-payment-frequency="annual"><?= $plan->annual_price ?></div>
                        <div class="h1 d-none" data-plan-payment-frequency="lifetime"><?= $plan->lifetime_price ?></div>
