...
<html lang="<?= \Altum\Language::$code ?>" dir="<?= l('direction') ?>" class="h-100">
    ...
    <body class="<?= l('direction') == 'rtl' ? 'rtl' : null ?> bg-gray-50 <?= \Altum\ThemeStyle::get() == 'dark' ? 'c_darkmode' : null ?>" data-theme-style="<?= \Altum\ThemeStyle::get() ?>">
    <?php //Saivra:DEMO if(DEMO) echo include_view(THEME_PATH . 'views/partials/ac_banner.php', ['demo_url' => 'https://ultrasmarttools.com/demo/', 'title_text' => 'ultrasmarttools by SaivraTechnologies', 'product_url' => 'https://ultrasmarttools.com-buy', 'buy_text' => 'Buy ultrasmarttools']) ?>
