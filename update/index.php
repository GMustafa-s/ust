...
<header class="header">
    <div class="container">
        <div class="d-flex">
            <div class="mr-3">
                <img src="./assets/images/logo.png" class="img-fluid logo" alt="SaivraTechnologies logo" />
            </div>
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <p class="subheader d-flex flex-row">
                    <span class="text-muted">
                        <a href="<?= PRODUCT_URL ?>" target="_blank" class="text-gray-500"><?= PRODUCT_NAME ?></a> by <a href="https://saivra.net" target="_blank" class="text-gray-500">SaivraTechnologies</a>
                    </span>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col" id="content">
                ...
                <section id="welcome" style="display: none">
                    <h2>Welcome</h2>
                    <p>Thank you for choosing the <a href="https://saivra.net" target="_blank">SaivraTechnologies</a> brand.</p>
                ...
                <section id="update" style="display: none">
                    ...
                    <form id="setup_form" method="post" action="" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="product_version" name="product_version" value="<?= $product_info ? $product_info->version : (defined('PRODUCT_VERSION') ? PRODUCT_VERSION : '4.0.0') ?>" aria-describedby="license_help" readonly="readonly">
                        </div>
