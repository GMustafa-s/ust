...
class AdminSettings extends Controller {
    ...
    public function cookie_consent() {
        ...
        if(isset($_GET['export']) && $_GET['export'] == 'csv') {
            //Saivra:DEMO if(DEMO) exit('This command is blocked on the demo.');
    ...
    public function webhooks() {
        ...
        if(!empty($_POST)) {
            ...
            /* :) */
            $_POST['user_new'] = trim(input_clean($_POST['user_new']));
            $_POST['user_delete'] = trim(input_clean($_POST['user_delete']));
            $_POST['payment_new'] = trim(input_clean($_POST['payment_new']));
    ...
    public function license() {
        ...
        if(!empty($_POST) && !empty($_POST['new_license'])) {
            ...
            $saivra_api = 'https://api.altumcode.com/validate';

            /* Make sure the license is correct */
            $response = \Unirest\Request::post($saivra_api, [], [
                'type'              => 'update',
    ...
    public function support() {
        ...
        if(!empty($_POST)) {
            ...
            //$saivra_api = 'http://127.0.0.1/saivra-api/get-support-status';
            $saivra_api = 'https://api.altumcode.com/get-support-status';
