...
class Contact extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['subject'] = mb_substr(trim(input_clean($_POST['subject'])), 0, 128);
            $_POST['message'] = mb_substr(trim(input_clean($_POST['message'])), 0, 2048);

            //Saivra:DEMO if(DEMO) if($this->user->user_id == 1) Alerts::add_error('Please create an account on the demo to test out this function.');
